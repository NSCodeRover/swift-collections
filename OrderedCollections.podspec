Pod::Spec.new do |spec|
  ...
  spec.version      = "1.2.0"
  spec.summary      = "Swift Collections - OrderedCollections module"
  spec.description  = <<-DESC
    Swift Collections is an open-source package of data structure implementations for the Swift programming language.
    
    This pod provides the OrderedCollections module which includes OrderedSet and OrderedDictionary.
  DESC
  ...
  # OrderedCollections source files
  spec.source_files = [
